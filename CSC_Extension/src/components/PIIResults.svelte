...
<section class="card bg-gradient-to-br from-slate-900/70 to-slate-800/60 shadow-lg border border-slate-700 rounded-2xl overflow-hidden max-w-3xl mx-auto">
